...
const DomainHostingPricing = () => {
    const basicPack = [
        {feature:'1 website'},
        {feature:'10,000 visitors monthly'},
        {feature:'1 free domain'},
        {feature:'free .np domain'},
    ...
    const premiumPack = [
        {feature:'5 website'},
        {feature:'25,000 visitors monthly'},
        {feature:'1 free domain'},
        {feature:'free .np domain'},
        {feature:'24/7 service'},
        {feature:'30 gb storage'},
    ]
    const professionalPack = [
        {feature:'unlimited website'},
        {feature:'1,00,000 visitors monthly'},
        {feature:'1 free domain'},
        {feature:'free .np domain'},
        {feature:'24/7 service'},
    ...
    <div id='pricing' className='lg:pt-14 lg:pb-32 py-8 px-4  lg:px-44'>
        ...
        <div className='grid lg:grid-cols-3 gap-3'>
            <div className='shadow-full-shadow-dark p-10 bg-gradient-to-br from-orange-400 to-orange-600 text-white rounded-2xl'>
                ...
                <h1 className='text-center font-bold text-5xl pt-2 pb-7'>Rs 5,000</h1>
...
export default DomainHostingPricing