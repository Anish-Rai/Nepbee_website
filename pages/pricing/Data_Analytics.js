...
const DataAnalyticsPricing = () => {
    const basicPack = [
        ...
        {feature:'Analytics and Complex Calculation service'},
    ...
    const premiumPack = [
        ...
        {feature:'Data Modeling'},
        {feature:'Analytics and Complex Calculation service'},
        {feature:'Web Scrapping'},
        {feature:'24x7 Support'},
        {feature:'R Programming'},
    ]
    ...
    <div id='pricing' className='lg:pt-14 lg:pb-32 py-8 px-4  lg:px-44'>
        ...
        <div className='grid lg:grid-cols-3 gap-3'>
            ...
            <div className=' text-white shadow-full-shadow-dark p-10 bg-gradient-to-br from-blue-700 to-purple-500 rounded-2xl'>
                ...
                <h1 className='text-center font-bold text-5xl pt-2  pb-7'>Rs 35,000</h1>
            ...
            <div className='shadow-full-shadow-dark p-10 bg-gradient-to-br from-black to-slate-800 text-white rounded-2xl'>
                ...
                <p className='text-center text-sm'>Suitable for large scale Enterprise</p>
                <h1 className='text-center font-bold text-5xl pt-2 pb-7'>Rs 60,000</h1>
...
export default DataAnalyticsPricing